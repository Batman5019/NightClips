...
// =====================
// VIDEO FRAME CAPTURE
// Extracts a frame from a video File and returns a Blob (JPEG)
// =====================
...
uploadBtn.onclick = async () => {
  ...
  try {
    ...
    if (isImage) {
      ...
      // No thumbnail — capture a frame from the video
      ...
      if (frameBlob) {
        ...
        if (frameError) {
          console.warn("Frame upload failed, continuing without thumbnail:", frameError);
          thumbnailPath = null;
        }
      }
    }
